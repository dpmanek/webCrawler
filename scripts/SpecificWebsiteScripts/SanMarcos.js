...
const BASE_URL =
  "https://www.sanmarcostx.gov/Bids.aspx?CatID=98&txtSort=Category&showAllBids=on&Status=";

export async function scrapeSanMarcos() {
  ...
  saveToCSV(flatBids, "san_marcos_bids.csv", false, [
    "Title",
    "BidNumber",
    "Status",
    "Closes",
