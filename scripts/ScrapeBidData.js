...
export async function scrapeBidDetails(bids) {
	...
	// Save updated data to CSV with correct field order for detailed bids
	...
	saveToCSV(bids, 'detailed_bids.csv', false, detailedFields);
}
...
export async function scrapeData() {
	...
	const bids = await page.evaluate(() => {
		...
		bidElements.forEach((bid) => {
			// Get bid date from the Bid Details section
